...
module "rds" {
  source = "git::ssh://git@github.com/Kuflink/infra-terraformcontrol.git//modules/rds?ref=v0.1.18"
...
module "rds_restore" {
  source = "git::ssh://git@github.com/Kuflink/infra-terraformcontrol.git//modules/rds-restored?ref=v0.1.59"
...
# Redshift Module
module "redshift" {
  source = "git::ssh://git@github.com/Kuflink/infra-terraformcontrol.git//modules/redshift?ref=v0.1.13"
...
module "redshift_restore" {
  source = "git::ssh://git@github.com/Kuflink/infra-terraformcontrol.git//modules/redshift-restored?ref=v0.1.16"
  count = local.enable_redshift && local.restore_redshift_from_snapshot ? 1 : 0
...
module "dms_mysql_to_redshift" {
  source = "git::ssh://git@github.com/Kuflink/infra-terraformcontrol.git//modules/dms-mysql-to-redshift?ref=v0.1.13"
